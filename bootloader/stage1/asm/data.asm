...
stage1.DAP: 		db	10h,0 
	.SectorsToRead:	dw	SWIFTOS_STAGE2_SIZE		; Number of sectors to read (read size of OS) 
	.Offset:		dw	SWIFTOS_STAGE2_OFFSET		; Offset :0000 
	.Segment:		dw	SWIFTOS_STAGE2_SEGMNT		; Segment 0200
	.End:			dq	SWIFTOS_STAGE2_SECTOR		; Sector 16 or 10h on CD-ROM
